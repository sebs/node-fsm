 ...
 */
exports.table.prototype.addTransition = function(fromState, toState, callback) {
	this.table[fromState][toState] = callback;
}

exports.table.prototype.massAddTransition = function(toState, cb) {
    for (i in this.table) {
        this.table[i][toState] = cb;
    }
}
/**
